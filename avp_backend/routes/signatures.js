...
function convertToString(num) {
  if (num < 10) { return String(num).padStart(3, '0') }
  if (num < 100 && num > 10) { return String(num).padStart(3, '0') }
  return String(num)
}

//iskljucivanje svega nepotrebnog da bi se ubrzalo dohvacanje podataka
const minimal_args = [
...
async function scrape() {
  ...
  for (let i = 1; i < 392; i++) {
    await page.goto(`https://agilemanifesto.org/display/000000${convertToString(i)}.html`, { waitUntil: 'domcontentloaded' })
